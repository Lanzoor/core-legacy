...
let announcements = [
    //
    new Announcement('0001', './0001.html', 'Hiatus Announcement', new Date('2026-01-19')),
    new Announcement(
        '0002',
        './0002.html',
    ...
    new Announcement('0003', './0003.html', 'Vacation Announcement', new Date('2026-02-04')),
    new Announcement(
        '0004',
        './0004.html',
    ...
    new Announcement('0005', './0005.html', 'Domain Registration Notice', new Date('2026-02-09')),
    new Announcement('0006', './0006.html', 'Life Update', new Date('2026-03-02')),
    new Announcement(
        '0007',
        './0007.html',
